...
from utils.utils import load_model, count_parameters, eval_model_dataloader_nli, eval_model_dataloader, compute_metrics, load_model_NL, eval_model_dataloader_nli_DL
        ...
        #Save a trained model and the associated configuration
            if (global_step % 2 == 0) & (epoch > 1): 
                if 'race' in task_name:
                    ...
                    test_res = eval_model_dataloader_nli_DL(args.task_name.lower(), eval_label_ids, student_encoder, student_classifier, eval_dataloader, args.kd_model, num_labels, device, args.weights, args.fc_layer_idx, output_mode, NL_mode = shuf)
                ...
                if task_name == 'mrpc':
                    ...
                    if test_res['eval_loss_M1'] + test_res['eval_loss_M2'] < eval_loss_min_all:
                        logger.info("")
                        logger.info('='*77)
                        logger.info("Validation (M1 + M2) loss improved! "+str(eval_loss_min_all)+" -> "+str(float(test_res['eval_loss_M1']+test_res['eval_loss_M2'])))
                        logger.info("Validation M1 loss: " +str(test_res['eval_loss_M1']))
                        logger.info("Validation M2 loss: " +str(test_res['eval_loss_M2']))
                        logger.info('='*77)
                        eval_loss_min_all = test_res['eval_loss_M1'] + test_res['eval_loss_M2']
                    ...
                    if test_res['f1_M1'] + test_res['f1_M2'] > eval_best_acc_all:
                        logger.info("")
                        logger.info('='*77)
                        logger.info("Validation (M1 + M2) f1 improved! "+str(eval_best_acc_all)+" -> "+str(float(test_res['f1_M1']+test_res['f1_M2'])))
                        logger.info("Validation M1 f1: " +str(test_res['f1_M1']))
                        logger.info("Validation M2 f1: " +str(test_res['f1_M2']))
                        logger.info('='*77)
                        eval_best_acc_all = test_res['f1_M1'] + test_res['f1_M2']
                    ...
                    if test_res['mcc_M1'] + test_res['mcc_M2'] > eval_best_acc_all:
                        logger.info("")
                        logger.info('='*77)
                        logger.info("Validation (M1 + M2) mcc improved! "+str(eval_best_acc_all)+" -> "+str(float(test_res['mcc_M1']+test_res['mcc_M2'])))
                        logger.info("Validation M1 f1: " +str(test_res['mcc_M1']))
                        logger.info("Validation M2 f1: " +str(test_res['mcc_M2']))
                        logger.info('='*77)
                        eval_best_acc_all = test_res['mcc_M1'] + test_res['mcc_M2']
                        if eval_best_acc_all > args.saving_criterion_acc:
                            if args.n_gpu > 1:
                                torch.save(student_encoder.module.state_dict(), os.path.join(args.output_dir, 'BERT'+f'.encoder_acc_all.pkl'))
                                torch.save(student_classifier.module.state_dict(), os.path.join(args.output_dir, 'BERT'+f'.cls_acc_all.pkl'))
                    ...
                    if test_res['acc_M1'] + test_res['acc_M2'] > eval_best_acc_all:
                        logger.info("")
                        logger.info('='*77)
                        logger.info("Validation (M1 + M2) acc improved! "+str(eval_best_acc_all)+" -> "+str(float(test_res['acc_M1']+test_res['acc_M2'])))
                        logger.info("Validation M1 f1: " +str(test_res['acc_M1']))
                        logger.info("Validation M2 f1: " +str(test_res['acc_M2']))
                        logger.info('='*77)
                        eval_best_acc_all = test_res['acc_M1'] + test_res['acc_M2']
                        if eval_best_acc_all > args.saving_criterion_acc:
                            if args.n_gpu > 1:
                                torch.save(student_encoder.module.state_dict(), os.path.join(args.output_dir, 'BERT'+f'.encoder_acc_all.pkl'))
                                torch.save(student_classifier.module.state_dict(), os.path.join(args.output_dir, 'BERT'+f'.cls_acc_all.pkl'))
